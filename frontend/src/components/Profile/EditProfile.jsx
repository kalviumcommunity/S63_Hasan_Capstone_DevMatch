...
import { EditProfileSchema } from "../../schemas/profileSchema.js";
import ToolTipMessage from "../Common/ToolTipMessage.jsx";
    ...
    return (
        <div className="card bg-base-100 shadow-xl">
            <div className="card-body px-4 sm:px-6">
                ...
                <p className="text-base-content/70 text-sm">Update your DevMatch profile information</p>
